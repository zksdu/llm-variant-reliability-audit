...
> Assembled 2026-08-06. Final numbers (30,000 evaluations + all sub-experiments). 5 figures, 4 tables, Wilson CI + McNemar, 17 verified references. Section order: Abstract, Methods, Introduction, Results, Discussion.
